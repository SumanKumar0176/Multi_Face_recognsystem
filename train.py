...
window.title("Multi Face Detection System")
...
frame2.place(relx=0.25, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Multiple Face Recognition System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
if exists:
    ...
    res = 0
message.configure(text='Number Of Data  : '+str(res))
...
#trackImg = tk.Button(frame1, text="Detect Person", command=TrackImages  ,fg="black"  ,bg="#1AFD03"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
